...
<section class="max-w-7xl mx-auto px-4 py-14 lg:py-20" aria-labelledby="why-heading">
	<div class="text-center max-w-2xl mx-auto mb-12">
		...
		<h2 id="why-heading" class="font-display font-extrabold text-3xl lg:text-4xl text-[var(--color-text)]">
	...
	<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
		...
		<div class="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl p-6 hover:border-brand-green hover:shadow-lg transition-all duration-200 group">
			...
			<h3 class="font-display font-bold text-lg text-[var(--color-text)] mb-2"><?php echo esc_html( $f['title'] ); ?></h3>
			<p class="text-[var(--color-text-muted)] text-sm leading-relaxed"><?php echo esc_html( $f['desc'] ); ?></p>
		</div>
		<?php endforeach; ?>
	</div>
</section>
