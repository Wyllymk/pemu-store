 ...
 * Used on checkout, product pages, and cart.
 */
$badges = [
...
<div class="flex flex-wrap items-center justify-center gap-<?php echo $compact ? '3' : '4'; ?> py-4">
	...
	<div class="flex flex-col items-center text-center gap-1 min-w-[60px]">
		...
		<span class="text-[10px] font-bold text-[var(--color-text)] leading-tight"><?php echo esc_html( $badge['title'] ); ?></span>
		<?php if ( $show_sub ) : ?>
		<span class="text-[9px] text-[var(--color-text-muted)] leading-tight"><?php echo esc_html( $badge['sub'] ); ?></span>
		<?php endif; ?>
	</div>
	<?php endforeach; ?>
</div>
