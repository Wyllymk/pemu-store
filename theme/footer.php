...
<footer class="bg-gray-100 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 pb-20 lg:pb-0 mt-auto">
    ...
    ?>
                    ...
                    <a href="<?php echo esc_url( $tiktok_url ); ?>" target="_blank" rel="noopener noreferrer"
                        aria-label="TikTok" class="group flex items-center justify-center w-9 h-9 rounded-full
                   ...
                   transition-colors">
                        ...
                        <svg class="w-4 h-4 !fill-slate-500 dark:!fill-slate-400 group-hover:!fill-brand-green"
                    ...
                    <a href="<?php echo esc_url( $instagram_url ); ?>" target="_blank" rel="noopener noreferrer"
                        aria-label="Instagram" class="group flex items-center justify-center w-9 h-9 rounded-full
                   !bg-white dark:!bg-slate-800
                   !border !border-slate-200 dark:!border-slate-400
                   !no-underline
                   hover:!border-brand-green
                   transition-colors">
                        ...
                        <svg class="w-4 h-4 !text-slate-500 dark:!text-slate-400 group-hover:!text-brand-green"
                    ...
                    <a href="<?php echo esc_url( pemu_whatsapp_url( 'Hi Pemu Ventures! 👋 I have a question.' ) ); ?>"
                        target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" class="group flex items-center justify-center w-9 h-9 rounded-full
               !bg-green-500
