...
<section class="bg-gray-100 dark:bg-[#1c2b38]" aria-labelledby="bestsellers-heading">
	<div class="max-w-7xl mx-auto px-4 py-14 lg:py-20">
		...
		<div class="flex items-end justify-between mb-8">
			<div>
				...
				<h2 id="bestsellers-heading" class="font-display font-extrabold text-3xl lg:text-4xl text-[#1a1a2e] dark:text-[#e8edf2]">
					<?php esc_html_e( 'Best Sellers', 'pemu' ); ?>
				</h2>
			</div>
			<a href="<?php echo esc_url( add_query_arg( 'orderby', 'popularity', function_exists( 'wc_get_page_permalink' ) ? wc_get_page_permalink( 'shop' ) : home_url( '/shop' ) ) ); ?>"
