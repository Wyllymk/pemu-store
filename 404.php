...
<main id="main-content" class="min-h-[70vh] flex items-center justify-center px-4 py-16">
	<div class="text-center max-w-lg mx-auto">
		...
		<h2 class="font-display font-bold text-2xl text-[var(--color-text)] mb-4">
			<?php esc_html_e( 'Page Not Found', 'pemu' ); ?>
		</h2>
		<p class="text-[var(--color-text-muted)] text-lg mb-8">
		...
		<div class="flex flex-wrap gap-3 justify-center">
			...
			<a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>"
			   class="inline-flex items-center gap-2 bg-[var(--color-surface)] border border-[var(--color-border)] hover:border-brand-green text-[var(--color-text)] font-bold px-7 py-3.5 rounded-xl transition-colors">
		...
		<!-- Search -->
		<div class="mt-10">
			<p class="text-sm text-[var(--color-text-muted)] mb-3"><?php esc_html_e( 'Or search for a product:', 'pemu' ); ?></p>
			<?php get_search_form(); ?>
		</div>
	</div>
</main>
