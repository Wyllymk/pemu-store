 ...
 * Pemu override: styled sort select.
 * @version 3.6.0
 */
...
<form class="woocommerce-ordering m-0" method="get">
	<select name="orderby"
	        class="orderby px-4 py-2.5 rounded-xl bg-[var(--color-surface)] border border-[var(--color-border)] text-sm font-semibold text-[var(--color-text)] focus:outline-none focus:ring-2 focus:ring-brand-green cursor-pointer"
